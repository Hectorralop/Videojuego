...
public class GameState extends State {
    ...
    public GameState() {
        returnButton = new Button(Assets.exit, Assets.exit,
                5, Constants.HEIGHT - Assets.exit.getHeight() - 40,
                new Action() {
                    @Override
        ...
        meteors = 1;
        startWave();
        backgroundMusic = new Sound(Assets.backgroundMusicGame);
        ...
        BufferedImage[] backgroundFrames = Assets.gameBackground;
        Vector2D backgroundPosition = new Vector2D(0, 0);
        backgroundAnimation = new Animation(backgroundFrames, 250, backgroundPosition);
    }
	...
	private void drawScore(Graphics g) {
		...
		Vector2D pos = new Vector2D(1090, 25);
