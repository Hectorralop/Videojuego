...
public class Constants {
	...
	public static final double DELTAANGLE = 0.060;
	...
	public static final String CONTROL_STATE = "JUGABILIDAD";
	
	public static final String SCORE = "PUNTOS";
	public static final String DATE = "FECHAS";
	
	public static final String SCORE_PATH = FileSystemView.getFileSystemView().getDefaultDirectory().getPath() +
			"\\Asteroids\\data.json"; // data.xml if you use XMLParser
